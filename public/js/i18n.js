...
const TRANSLATIONS = {
  de: {
    ...
    'set.providerSection': 'KI-Anbieter',
    'set.providerDesc': 'Wähle Deinen KI-Anbieter für Textgenerierung (Artikel, Outreach). Kimi und OpenAI sind vorkonfiguriert.',
    'set.provider': 'Anbieter',
    'set.providerKimi': 'Kimi (Moonshot AI) — Empfohlen für Text',
    'set.providerOpenai': 'OpenAI — Text + Bildgenerierung',
    'set.providerCustom': 'Benutzerdefiniert (OpenAI-kompatibel)',
    'set.providerHint.kimi': 'API-Key erstellen: platform.kimi.ai — Kostenloses Kontingent verfügbar.',
    'set.providerHint.openai': 'API-Key erstellen: platform.openai.com — Unterstützt auch DALL-E Bildgenerierung.',
    'set.providerHint.custom': 'Jeder OpenAI-kompatible Endpunkt (Ollama, LM Studio, Azure, Groq, etc.)',
    'set.llmSection': 'Text-KI Konfiguration',
    'set.llmDesc': 'API-Zugangsdaten für den Artikel-Generator und den Outreach Bot.',
    'set.apiKey': 'API-Key',
    'set.apiKeyPlaceholder': 'Dein API-Key...',
    'set.apiUrl': 'API-URL',
    'set.apiUrlPlaceholder': 'https://api.moonshot.ai/v1',
    'set.apiModel': 'Modell',
    'set.apiModelPlaceholder': 'moonshot-v1-8k',
    ...
    'set.imageKeyHint': 'Leer lassen = Text-API-Key wird verwendet',
    'set.customCompatible': 'OpenAI-kompatibel',
  ...
  en: {
    ...
    'set.providerSection': 'AI Provider',
    'set.providerDesc': 'Choose your AI provider for text generation (articles, outreach). Kimi and OpenAI are pre-configured.',
    'set.provider': 'Provider',
    'set.providerKimi': 'Kimi (Moonshot AI) — Recommended for Text',
    'set.providerOpenai': 'OpenAI — Text + Image Generation',
    'set.providerCustom': 'Custom (OpenAI-compatible)',
    'set.providerHint.kimi': 'Get your API key: platform.kimi.ai — Free tier available.',
    'set.providerHint.openai': 'Get your API key: platform.openai.com — Also supports DALL-E image generation.',
    'set.providerHint.custom': 'Any OpenAI-compatible endpoint (Ollama, LM Studio, Azure, Groq, etc.)',
    'set.llmSection': 'Text AI Configuration',
    'set.llmDesc': 'API credentials for the Article Generator and Outreach Bot.',
    'set.apiKey': 'API Key',
    'set.apiKeyPlaceholder': 'Your API key...',
    'set.apiUrl': 'API URL',
    'set.apiUrlPlaceholder': 'https://api.moonshot.ai/v1',
    'set.apiModel': 'Model',
    'set.apiModelPlaceholder': 'moonshot-v1-8k',
    ...
    'set.imageKeyHint': 'Leave empty = Text API key will be used',
    'set.customCompatible': 'OpenAI-compatible',
